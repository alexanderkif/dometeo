...
export default {
  ...
  backend: {
    ...
    li6: ['Зарегистрироваться на ', 'Zeit.co (Now) "Continue with GitHub"', '. Там автоматически будет запускаться наше Backend приложение с GitHub.'],
    li7: 'Создать новый проект на Zeit.co. Привязать его к своему репозиторию meteo на GitHub (GIT INTEGRATION). Добавить uri базы данных в переменные окружения.',
